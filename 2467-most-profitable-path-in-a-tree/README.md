...
<pre style="position: relative;"><strong>Input:</strong> edges = [[0,1],[1,2],[1,3],[3,4]], bob = 3, amount = [-2,4,2,-4,6]
...
<pre style="position: relative;"><strong>Input:</strong> edges = [[0,1]], bob = 1, amount = [-7280,2350]
