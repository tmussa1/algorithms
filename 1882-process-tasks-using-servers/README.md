...
<pre style="position: relative;"><strong>Input:</strong> servers = [3,3,2], tasks = [1,2,3,2,1,2]
...
- At second 5, all servers become free. Task 5 is added and processed using server 2 until second 7.<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong class="example">Example 2:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> servers = [5,1,4,3,2], tasks = [2,1,2,4,5,2,1]
