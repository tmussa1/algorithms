...
<pre style="position: relative;"><strong>Input:</strong> calories = [1,2,3,4,5], k = 1, lower = 3, upper = 3
...
<pre style="position: relative;"><strong>Input:</strong> calories = [3,2], k = 2, lower = 0, upper = 1
...
<pre style="position: relative;"><strong>Input:</strong> calories = [6,5,0,0], k = 2, lower = 1, upper = 5
<strong>Output:</strong> 0
