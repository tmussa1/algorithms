...
<pre style="position: relative;"><strong>Input:</strong> area = 4
...
<pre style="position: relative;"><strong>Input:</strong> area = 37
<strong>Output:</strong> [37,1]
<div class="open_grepper_editor" title="Edit &amp; Save To Grepper"></div></pre>

<p><strong>Example 3:</strong></p>

<pre style="position: relative;"><strong>Input:</strong> area = 122122
