...
<pre style="position: relative;"><strong>Input:</strong> prices = ["0.700","2.800","4.900"], target = 8
...
<pre style="position: relative;"><strong>Input:</strong> prices = ["1.500","2.500","3.500"], target = 10
...
<pre style="position: relative;"><strong>Input:</strong> prices = ["1.500","2.500","3.500"], target = 9
