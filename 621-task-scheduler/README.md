...
<pre style="position: relative;"><strong>Input:</strong> tasks = ["A","A","A","B","B","B"], n = 2
...
<pre style="position: relative;"><strong>Input:</strong> tasks = ["A","A","A","B","B","B"], n = 0
...
<pre style="position: relative;"><strong>Input:</strong> tasks = ["A","A","A","A","A","A","B","C","D","E","F","G"], n = 2
