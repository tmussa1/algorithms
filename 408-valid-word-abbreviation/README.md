...
<pre style="position: relative;"><strong>Input:</strong> word = "internationalization", abbr = "i12iz4n"
...
<pre style="position: relative;"><strong>Input:</strong> word = "apple", abbr = "a2e"
