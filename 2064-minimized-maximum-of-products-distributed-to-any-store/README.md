...
<pre style="position: relative;"><strong>Input:</strong> n = 6, quantities = [11,6]
...
<pre style="position: relative;"><strong>Input:</strong> n = 7, quantities = [15,10,10]
...
<pre style="position: relative;"><strong>Input:</strong> n = 1, quantities = [100000]
