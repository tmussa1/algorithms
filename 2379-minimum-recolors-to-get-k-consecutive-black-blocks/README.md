...
<pre style="position: relative;"><strong>Input:</strong> blocks = "WBBWWBBWBW", k = 7
...
<pre style="position: relative;"><strong>Input:</strong> blocks = "WBWBBBW", k = 2
